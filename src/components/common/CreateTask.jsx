const CreateTask = () => {
  return (
    <div className="p-5 bg-[#1c1c1c] mt-7 rounded">
      <form className="flex flex-wrap w-full items-start justify-between  text-sm">
        <div className="w-1/2">
          <div>
        ...
        <div className="w-2/5 flex flex-col items-start">
          ...
          <textarea
            className="w-full h-44 text-black py-2 rounded outline-none border-[1px] border-gray-400 placeholder:gray-200 rounded outline-none"
            name=""
            id=""
            cols="30"
            rows="10"
